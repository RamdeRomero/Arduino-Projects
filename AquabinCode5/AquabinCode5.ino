...
void setup() {
  ...
  // Gsm setup Gsm setup  Gsm setup Gsm setup
      ...
      //send message
        ...
        updateSerial();
        mySerial.print("The bin is Ready to receive commands... reply BIN ON - to turn on or BIN OFF - to stop | Visit http://192.168.45,147/ to monitor the AQUABIN."); //text content
        updateSerial();
        mySerial.write(26);
      ...
      rtc.setTime(0, 0, 50);   // Set the time to 12:00:00 (24hr format)
...
//        mySerial.println("AT+CMGS=\"+639639874383\"");//change ZZ with country code and xxxxxxxxxxx with phone number to sms
//        updateSerial();
//        mySerial.print("The bin water level is Sufficient. Detection Ready"); //text content
//        updateSerial();
//        mySerial.write(26); 
//        
//       }
      ...
      if (t.hour == OnHour && t.min == OnMin) {
        if((cm>170) && (cm<150)){
          ...
          if(y1 == 1){
            ...
            mySerial.println("AT+CMGS=\"+639639874383\"");//change ZZ with country code and xxxxxxxxxxx with phone number to sms
            updateSerial();
            mySerial.print("The bin is Turned on by Timer"); //text content
            updateSerial();
            mySerial.write(26);
          }
        ...
        mySerial.println("AT+CMGS=\"+639639874383\"");//change ZZ with country code and xxxxxxxxxxx with phone number to sms
        updateSerial();
        mySerial.print("The bin is Turned off by Timer"); //text content
        updateSerial();
        mySerial.write(26);
        }
      }
...
//       }
    ...
    //##########################
      ...
      if(cm<=170 && (cm>150)){
        ...
        mySerial.println("AT+CMGS=\"+639639874383\"");//change ZZ with country code and xxxxxxxxxxx with phone number to sms
        updateSerial();
        mySerial.print("The bin is full. Verify through Web server https://192.168.45,147/ Please reply BIN OFF if you wish to deactivate pump."); //text content
        updateSerial();
        mySerial.write(26);
        ...
        mySerial.println("AT+CMGS=\"+639639874383\"");//change ZZ with country code and xxxxxxxxxxx with phone number to sms
        updateSerial();
        mySerial.print("Foreign Object Detected"); //text content
        updateSerial();
        mySerial.write(26);
        delay(15000);
...
//        mySerial.println("AT+CMGS=\"+639639874383\"");//change ZZ with country code and xxxxxxxxxxx with phone number to sms
//        updateSerial();
//        mySerial.print("The water level is too high... shutting down... | visit https://192.168.45,147/ to monitor the aquabin"); //text content
//        updateSerial();
//        mySerial.write(26);
//        
//        digitalWrite(relayPin, LOW);
...
//  }
    ...
    //send message
        ...
        mySerial.println("AT+CMGS=\"+639639874383\"");//change ZZ with country code and xxxxxxxxxxx with phone number to sms
        updateSerial();
        mySerial.print("The bin water level is Insufficient. Check bin. "); //text content
        updateSerial();
        mySerial.write(26);
        delay(15000);
  }
